    ...
    <div className="flex flex-col h-full bg-white dark:bg-zinc-950 border-r border-gray-200 dark:border-zinc-900 w-64">
      ...
      <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100 dark:border-zinc-900">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <span className="font-bold text-sm text-gray-900 dark:text-zinc-100 tracking-tight block">
              {settings.businessName}
            </span>
            <span className="text-[10px] text-gray-500 dark:text-zinc-400 font-bold tracking-wider uppercase block">
              {t('staffPortal')}
            </span>
          </div>
        </div>
      ...
      <div className="p-4 border-t border-gray-100 dark:border-zinc-900 flex flex-col gap-2 bg-gray-50/20">
        <div className="flex items-center gap-3 p-2 bg-gray-50 dark:bg-zinc-900/50 rounded-lg">
          <div className="w-8 h-8 rounded-full bg-gray-200 dark:bg-zinc-800 flex items-center justify-center text-xs font-bold text-gray-700 dark:text-zinc-300">
            S
          </div>
          <div className="min-w-0 flex-1 text-xs">
            ...
            <p className="text-[9px] text-gray-500 dark:text-zinc-400 truncate flex items-center gap-0.5 mt-0.5">
